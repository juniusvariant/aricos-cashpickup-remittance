...
mobile </br><small><span style="color:grey">*required* </span></small>| `object` Customer’s mobile number.
mobile.country_code </br><small><span style="color:grey">*required* </span></small>| `string` Customer’s mobile number international  country prefix. Recommended if you want to notify the customer of the transaction status</br></br> 2-letter ISO 3166-2 country code. Refer to code standard [here](https://www.nationsonline.org/oneworld/country_code_list.htm). Example: 62
mobile.number </br><small><span style="color:grey">*required* </span></small>| `string` Customer’s mobile number without international prefix. Recommended if you want to notify the customer of the transaction status</br> Example: 812XXXXXX
